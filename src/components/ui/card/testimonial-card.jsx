...
export default function TestimonialCard({ data }) {
    const {
        ...
        onVideo = "Mastering UX/UI Design: From Basics to Advanced Techniques",
        videoHref = "/",
    } = data;

    return (
        <div className="relative p-base bg-background rounded border overflow-hidden">
            <div className="absolute right-base bottom-16 size-28 select-none pointer-events-none">
            ...
            <p className="text-[15px] text-foreground leading-5 aspect-[4/3] md:aspect-[4/3]">
                {testimonial}
            </p>

            <div className="py-base flex items-center gap-xs">
                <Image
                ...
                <div className="">
                    ...
                    <div className="-mt-1 text-muted-foreground text-sm">May 2024</div>
                </div>
            </div>
            <hr />
            <div className="pt-base flex items-center gap-xs">
                <Link className="font-bold text-link hover:underline leading-5 line-clamp-2 cursor-pointer" href={videoHref}>
                    {onVideo}
                </Link>
            </div>
        </div>
